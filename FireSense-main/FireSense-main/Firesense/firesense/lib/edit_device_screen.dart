  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: bgGrey,
        elevation: 0,
        title: const Text('Edit Device', style: TextStyle(color: Color(0xFF8B0000), fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Text('Add Photo', style: TextStyle(color: Colors.grey)),
              ),
              const SizedBox(height: 32),
              SizedBox(
                width: double.infinity,
